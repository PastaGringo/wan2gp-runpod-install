...
echo "   python wgp.py --listen --server-port 7860 --share"
echo ""
echo " The --share flag creates a public gradio.live tunnel (valid 1 week)."
echo " For a permanent URL, expose port 7860 on the pod and use the RunPod proxy."
echo ""
